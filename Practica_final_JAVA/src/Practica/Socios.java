...
public class Socios extends javax.swing.JFrame {
    ...
    private final String insert = "INSERT INTO Socios(Num_Socio, Nombre, DNI, Telefono, Fecha_Alta) VALUES (?, ?, ?, ?, ?)";
    private final String update = "UPDATE Socios SET Nombre = ?, DNI = ?, Telefono = ?, Fecha_Alta = ?, WHERE Num_Socio = ?";
    private final String select = "SELECT Num_Socio, Nombre, DNI, Telefono, Fecha_Alta FROM Socios";
    private final String delete = "DELETE FROM Socios WHERE Num_Socio = ?";
    ...
    private void initComponents() {
        ...
        Nombre.setBackground(new java.awt.Color(218, 210, 216));
        Nombre.setFont(new java.awt.Font("DejaVu Sans", 0, 14)); // NOI18N
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(Nombre, javax.swing.GroupLayout.DEFAULT_SIZE, 220, Short.MAX_VALUE)
                .addContainerGap())
        );
        ...
        DNI.setBackground(new java.awt.Color(218, 210, 216));
        DNI.setFont(new java.awt.Font("DejaVu Sans", 0, 14)); // NOI18N
        ...
        jPanel5Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(DNI, javax.swing.GroupLayout.DEFAULT_SIZE, 220, Short.MAX_VALUE)
                .addContainerGap())
        );
        ...
        Telefono.setBackground(new java.awt.Color(218, 210, 216));
        Telefono.setFont(new java.awt.Font("DejaVu Sans", 0, 14)); // NOI18N
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Num_Socio", "Nombre", "DNI", "Telefono","Fecha_Alta"
            }
        ));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            pst.setObject(2, Nombre.getText());
            pst.setObject(3, DNI.getText());
            pst.setObject(4, Telefono.getText());
